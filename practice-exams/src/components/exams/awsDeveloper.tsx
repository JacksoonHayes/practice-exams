    ...
    return (
      <div className='relative min-h-screen'>
        ...
        <div className='relative z-10 container mx-auto px-4 py-12 max-w-4xl'>
          ...
          <div className='bg-[rgba(12,20,28,0.75)] border border-[rgba(150,180,200,0.22)] border-l-4 border-l-[#f5a623] p-8 backdrop-blur-sm'>
            <div className='mb-8'>
              <span
                className='inline-block text-sm px-3 py-2 border border-[rgba(245,166,35,0.4)] bg-[rgba(8,16,24,0.6)] tracking-wider'
                style={{ color: "#f5a623" }}
              >
                DVA-C02
              </span>
              <h1
                ...
                style={{
                  color: "#e8f4fb",
                  textShadow: "2px 2px 0 #0a2230, 0 0 12px rgba(245,166,35,0.4)",
                }}
              >
        ...
        <div className='bg-[rgba(12,20,28,0.75)] border border-[rgba(150,180,200,0.22)] p-6 backdrop-blur-sm mb-4'>
          <div className='flex items-start justify-between mb-4'>
            <div className='flex items-center gap-3 flex-wrap'>
              ...
              <span
                className='text-xs px-3 py-1 border border-[rgba(245,166,35,0.4)] bg-[rgba(8,16,24,0.6)]'
                style={{ color: "#f5a623" }}
              >
                {question.domain}
              </span>

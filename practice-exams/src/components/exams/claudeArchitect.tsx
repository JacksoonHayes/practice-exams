    ...
    return (
      <div className='relative min-h-screen'>
        <div
          ...
          style={{ backgroundImage: "url(/CfKUpQS.jpg)", backgroundPosition: "center center", backgroundAttachment: "fixed", filter: "brightness(1.25) saturate(1.05)" }}
        />
        <div
        ...
        <div className='relative z-10 container mx-auto px-4 py-12 max-w-4xl'>
          ...
          <div
            className='bg-[rgba(12,20,28,0.75)] border border-[rgba(150,180,200,0.22)] p-8 backdrop-blur-sm'
            style={{ borderLeftWidth: 4, borderLeftColor: ACCENT }}
          >
            <div className='mb-8'>
              <span
                className='inline-block text-sm px-3 py-2 border bg-[rgba(8,16,24,0.6)] tracking-wider'
              ...
              <h1
                ...
                style={{ color: "#e8f4fb", textShadow: `2px 2px 0 #0a2230, 0 0 12px rgba(232,116,74,0.35)` }}
              >
            ...
            <div className='bg-[rgba(8,16,24,0.6)] border border-[rgba(150,180,200,0.3)] p-6 mb-8'>
              <h2 className='text-2xl mb-4 tracking-wide' style={{ color: "#eaf2f8" }}>
                Exam Details
              </h2>
          ...
          <div className='bg-[rgba(12,20,28,0.75)] border border-[rgba(150,180,200,0.22)] p-8 backdrop-blur-sm text-center'>
            ...
            <div className='grid grid-cols-2 md:grid-cols-4 gap-4 mb-8'>
              {[
                ...
                { label: "Unanswered", value: unanswered, color: "#eaf2f8" },
                { label: "Time used", value: `${mins}:${String(scs).padStart(2, "0")}`, color: "#eaf2f8" },
              ].map((stat) => (
                <div key={stat.label} className='bg-[rgba(8,16,24,0.6)] border border-[rgba(150,180,200,0.3)] p-4'>
        ...
        <div className='bg-[rgba(12,20,28,0.75)] border border-[rgba(150,180,200,0.22)] p-6 backdrop-blur-sm mb-4'>
          <div className='flex items-start justify-between mb-4'>
            <div className='flex items-center gap-3 flex-wrap'>
              ...
              <span
                className='text-xs px-3 py-1 border bg-[rgba(8,16,24,0.6)]'
                style={{ color: ACCENT, borderColor: ACCENT_DIM }}
              >
                {question.domain}
              </span>
            ...
            {question.opts.map((opt, i) => {
              ...
              return (
                <div
                  ...
                  className={`flex items-start gap-3 p-4 border transition-all ${!locked && !paused ? "cursor-pointer hover:bg-[rgba(40,75,100,0.3)]" : ""}`}
